    ...
    return (
        <div className="flex min-h-screen w-full">
            ...
            <aside className={clsx("flex flex-col border-r bg-background transition-all duration-300 p-4 h-full", {
                ...
                <Button className="bg-gray-100 hover:bg-gray-50 text-zinc-900 self-end"
                ...
                <Collapsible className="mt-6" open={!isCollapsed}>
                    <CollapsibleContent>
                        <nav className="flex flex-col gap-1 overflow-hidden">
                            <span className="test-sm text-gray-400 font-medium mt-1 uppercase">
                                PAINEL
                            </span>
                        </nav>
            ...
            <header className="md:hidden flex items-center justify-between border-b px-2 md:px-6 h-14 z-10">
                <Sheet>
...
function SidebarLink({ href, icon, label, pathname, isCollapsed }: SidebarLinkProps) {
    return (
        <Link href={href}>
            <div className={clsx("flex items-center gap-2 py-3 rounded-md transition-colors",
                {
